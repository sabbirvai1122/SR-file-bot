...
async def stream_handler(request):
    try:
        ...
        # সরাসরি টেলিগ্রাম সার্ভার থেকে ফাইল স্ট্রিম করা হচ্ছে
...
async def watch_handler(request):
    file_id = request.match_info['file_id']
    download_url = f"{DOMAIN_URL}/download/{file_id}"
...
async def handle_media(client, message):
    ...
    try:
        ...
        # সরাসরি টেলিগ্রামের আসল file_id ব্যবহার করা হয়েছে
        file_id = media.file_id
        
        watch_link = f"{DOMAIN_URL}/watch/{file_id}"
        download_link = f"{DOMAIN_URL}/download/{file_id}"
...
async def main():
    ...
    app.router.add_get('/download/{file_id}', stream_handler)
